...
function setup() {
  ...
  runGame.position(width-690,height-340);

  texT = createElement('h1');
  texT.html("PRESS SPACE TO JUMP");
  texT.position(width-880,height-470);
...
function spawnObstacles() {
  if (frameCount % 120 === 0) {
    ...
    if (rand===1){
      ...
      var obstacle1d = createSprite(width,height-50,30,530); 
    ...
    if (rand===2){
      var obstacle2 = createSprite(width,height-500,30,300);
